...
"""
Make a parse args for patch aka put or update
"""
video_patch_args = reqparse.RequestParser()
#video_patch_args.add_argument("name",type = str, help = "Name of the video", required = True)
...
class Video(Resource):
    ...
    def patch(self,video_id):
        ...
        if not result:
            abort(405,message = "No video to update")
        
        if args["name"]: # args all ready have name views and likes
